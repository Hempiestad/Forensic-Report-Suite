...
def rate_limit(*, limit: int, window_seconds: int, strategy: str = "user_or_ip", scope: str = "endpoint", limiter: Optional[InMemorySlidingWindowRateLimiter] = None) -> Callable[[Callable[..., Any]], Callable[..., Any]]:
    if limit <= 0:
